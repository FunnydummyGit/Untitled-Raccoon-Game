...
public:
	...
	void init(int SCR_WIDTH, int SCR_HEIGHT, std::string path);
};
...
void Text::init(int SCR_WIDTH, int SCR_HEIGHT, std::string path) {
    // OpenGL state
    // ------------
    ...
    // ----------------------------
    Shader shader("assets/shader/TextShader.vs", "assets/shader/TextShader.fs");
    shaderID = shader.ID;
